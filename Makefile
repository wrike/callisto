...
lint:
	python -m flake8 --max-line-length=${MAX_LINE_LENGTH} --ignore E203,E501,W503,A003 ${PYTHON_MODULE} ${TESTS_PATH}
...
pyfmt:
	...
	python -m flake8 --max-line-length=${MAX_LINE_LENGTH} --ignore E203,E501,W503,A003 ${PYTHON_MODULE} tests
	python -m mypy ${PYTHON_MODULE}
