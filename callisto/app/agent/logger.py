...
class AddInstanceIdFilter(logging.Filter):
    ...
    def filter(self, record: logging.LogRecord) -> bool:
        record.instance_id = self.instance_id  # type: ignore
        return True


def get_default_logging_config(instance_id: str,
                               graylog_config: t.Optional[GraylogParameters] = None) -> t.Dict[str, t.Any]:
...
def init_logger(*, config: t.Dict[str, t.Any], log_level: int) -> None:
