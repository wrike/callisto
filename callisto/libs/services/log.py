...
def traced_logger_adapter_factory(trace_id_getter: t.Callable[[], str],
                                  separator: str = ">>>",
                                  overall_context: t.Optional[t.Mapping[str, t.Any]] = None,
                                  ) -> t.Type[logging.LoggerAdapter]:
    class TracedLoggerAdapter(logging.LoggerAdapter):
        # an adapter to reformat log message and parse additional context

        def process(self, msg: str, kwargs: t.MutableMapping[str, t.Any]) -> t.Tuple[str, t.Dict[str, t.Any]]:
            message_context = {
                'tid': trace_id_getter(),
            }
            ...
            return update_msg, t.cast(t.Dict[str, t.Any], kwargs)

    return TracedLoggerAdapter


def add_trace_context(trace_context: t.Optional[t.Mapping[str, t.Any]] = None,
                      additional: t.Optional[t.Mapping[str, t.Any]] = None,
                      **kwargs: t.Any) -> t.Dict[str, t.Any]:
    ...
    context = {
        TRACE_CONTEXT_KEY_NAME: normalized_context
    }
...
def extract_trace_context(context: t.MutableMapping[str, t.Any]) -> t.Dict[str, t.Any]:
